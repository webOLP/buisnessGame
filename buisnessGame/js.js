import {lvlCurrentLocal, curExpLocal} from './localInfo.js'
...
//
let expCount = 0;
export let lvlCurrent = 0;
const jobList = ['Дворник','Уборщик','Промоутер','Кассир','Таксист','Менеджер','Гл.Менеджер','Директор','Гл.Директор','Владелец холдинга']
...
function upgradeLvl() {
    ...
    expNeeded.textContent = Math.round(Number(expNeeded.textContent) + 25);
    if(lvlCurrent % 2 != 0) {
